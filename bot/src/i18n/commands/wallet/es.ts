...
Ahora, recarga saldo en tu /wallet de manera segura con una transferencia bancaria, un depósito en efectivo o un pago con tarjeta usando el comando /billetera recargar !

Puedes recargarla tú mismo o compartir el enlace con alguien más.

Si deseas saber que más puedes hacer con tu nueva billetera utiliza el comando /billetera ayuda
