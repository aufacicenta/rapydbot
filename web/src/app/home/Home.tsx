...
import { HomeBanner } from "ui/icons/HomeBanner";
...
export const Home = ({ className }: HomeProps) => (
  <div className={clsx(styles.home, className)}>
    <MainPanel.Container>
      ...
      <HomeBanner className={styles.home__banner} />
      ...
      <section className={styles.home__section}>
        ...
        <div className={styles["home__faqs--box"]}>
          ...
          <Typography.Text>
            TGI pays 0.5 USDT per reply. For a campaign of 1 question, expecting 100 replies, you pay 50 USDT. We charge
            2% per active campaign.
          </Typography.Text>
        </div>
        <div className={styles["home__faqs--box"]}>
        ...
        <div className={styles["home__faqs--box"]}>
          ...
          <Typography.Text>
            You control the radius or territory of your campaign. You can target a single town, an entire country or the
            whole world. TGI will summon the informers network and you get to verify each reply for its quality.
          </Typography.Text>
        </div>
        <div className={styles["home__faqs--box"]}>
          <Typography.Headline3>How do I make sure there are no informers with multiple accounts?</Typography.Headline3>
          <Typography.Text>
        ...
        <Grid.Row>
          ...
          <Grid.Col lg={6} className={styles["home__use-cases--card-box"]}>
            <Card className={styles["home__use-cases--card"]}>
              ...
              <Card.Content>
                <Typography.Text flat>
                  Request the price of a certain commodity, targetted by region. Use the data to create a real-time feed
                  by fetching our API.
                </Typography.Text>
              </Card.Content>
            </Card>
          ...
          <Grid.Col lg={6} className={styles["home__use-cases--card-box"]}>
            <Card className={styles["home__use-cases--card"]}>
              ...
              <Card.Content>
                <Typography.Text flat>
                  Request hundreds of ways to respond to a certain question. The newest text AI models require at least
                  100 different ways of writing the same prompt.
                </Typography.Text>
              </Card.Content>
            </Card>
          </Grid.Col>
