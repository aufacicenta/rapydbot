...
goog.exportSymbol('proto.user.FindUserByTelegramUserIdReply', null, global);
goog.exportSymbol('proto.user.FindUserByTelegramUserIdRequest', null, global);
 ...
 * @constructor
 */
proto.user.FindUserByTelegramUserIdRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.FindUserByTelegramUserIdRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.FindUserByTelegramUserIdRequest.displayName = 'proto.user.FindUserByTelegramUserIdRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.user.FindUserByTelegramUserIdReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.FindUserByTelegramUserIdReply, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.FindUserByTelegramUserIdReply.displayName = 'proto.user.FindUserByTelegramUserIdReply';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.user.GetUsersRequest.repeatedFields_ = [1];
 ...
 * @return {!Array<string>}
 */
proto.user.GetUsersRequest.prototype.getUserIdList = function() {
 ...
 */
proto.user.GetUsersRequest.prototype.setUserIdList = function(value) {
 ...
 * @return {!proto.user.GetUsersRequest} returns this
 */
proto.user.GetUsersRequest.prototype.addUserId = function(value, opt_index) {
 ...
 * @return {!proto.user.GetUsersRequest} returns this
 */
proto.user.GetUsersRequest.prototype.clearUserIdList = function() {
 ...
 * @return {!Object}
 */
proto.user.FindUserByTelegramUserIdRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.user.FindUserByTelegramUserIdRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.FindUserByTelegramUserIdRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.FindUserByTelegramUserIdRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    telegramFromUserId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.FindUserByTelegramUserIdRequest}
 */
proto.user.FindUserByTelegramUserIdRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.FindUserByTelegramUserIdRequest;
  return proto.user.FindUserByTelegramUserIdRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.FindUserByTelegramUserIdRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.FindUserByTelegramUserIdRequest}
 */
proto.user.FindUserByTelegramUserIdRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.FindUserByTelegramUserIdRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.FindUserByTelegramUserIdRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.FindUserByTelegramUserIdRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.FindUserByTelegramUserIdRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTelegramFromUserId();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.user.FindUserByTelegramUserIdRequest.prototype.getTelegramFromUserId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.user.FindUserByTelegramUserIdRequest} returns this
 */
proto.user.FindUserByTelegramUserIdRequest.prototype.setTelegramFromUserId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.user.FindUserByTelegramUserIdReply.prototype.toObject = function(opt_includeInstance) {
  return proto.user.FindUserByTelegramUserIdReply.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.FindUserByTelegramUserIdReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.FindUserByTelegramUserIdReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.FindUserByTelegramUserIdReply}
 */
proto.user.FindUserByTelegramUserIdReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.FindUserByTelegramUserIdReply;
  return proto.user.FindUserByTelegramUserIdReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.FindUserByTelegramUserIdReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.FindUserByTelegramUserIdReply}
 */
proto.user.FindUserByTelegramUserIdReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.FindUserByTelegramUserIdReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.FindUserByTelegramUserIdReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.FindUserByTelegramUserIdReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.FindUserByTelegramUserIdReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.user.FindUserByTelegramUserIdReply.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.user.FindUserByTelegramUserIdReply} returns this
 */
proto.user.FindUserByTelegramUserIdReply.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
